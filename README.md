...
## 💡 Scenario Context
This project simulates a **mid-sized enterprise operating in a cloud-based Azure environment**, assessing risks related to identity and access management practices.
